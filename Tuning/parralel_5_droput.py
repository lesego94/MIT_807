...
def process_index(Dropout):
    ...
    Lag=1; LagSD=5; Timestep=10;  LearningRate=0.01; Epochs=100
    ...
    for i in tqdm(range(IndexEndDays.shape[0])):
        ...
        #Results are saved
        ResultsCollection.to_csv(f'./Dropout/MTL_GARCH_{Dropout}.csv',index=False)
...
def main():
    ...
    with mp.Pool(4) as pool:
        ...
        results = pool.map(process_index, Dropout)
