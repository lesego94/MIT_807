...
def process_index(LearningRate):
    ...
    Lag=1; LagSD=5; Timestep=10; Dropout = 0.01; Epochs=100
    ...
    for i in tqdm(range(IndexEndDays.shape[0])):
        ...
        #Results are saved
        ResultsCollection.to_csv(f'./learning_rate/MTL_GARCH_{LearningRate}.csv',index=False)
...
def main():
    ...
    with mp.Pool(5) as pool:
        ...
        results = pool.map(process_index, learning_rate)
